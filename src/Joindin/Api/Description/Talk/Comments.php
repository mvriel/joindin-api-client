...
namespace Joindin\Api\Description\Talk;
...
{
    /**
     * Service definition for the talk comments endpoint.
     *
     * @var string[]
     */
    private $definition = array(
        'operations' => array(
            ...
            'submit' => array(
                ...
                'parameters'    => array(
                    ...
                    'rating'  => array('type' => 'integer', 'location' => 'json', 'required' => true),
        ...
        'models' => array(
            'object' => array(
                'type' => 'object',
                'additionalProperties' => array('location' => 'json', 'mapper' => 'Joindin\Api\Mapper\Talk\Comment[]')
            ),
